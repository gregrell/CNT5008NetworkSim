 ...
 * @author Ivan Marsic
 */
public class SenderVegas2 extends Sender {
	...
	public SenderVegas2(Endpoint localTCPendpoint_) {
		...
		SenderStateCongestionAvoidanceVegas2 congestionAvoidanceState =
			new SenderStateCongestionAvoidanceVegas2(
				this, slowStartState, null /* after 3x DupACKs state */
			);
		SenderState fastRecoveryState = new SenderStateFastRecoveryVegas2(
